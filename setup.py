...
setup(
  ...
  description = 'first package test',   # Give a short description about your library
  author = 'Jaime Silva',                   # Type in your name
  author_email = 'jaimedcsilva@hotmail.com',      # Type in your E-Mail
  url = 'https://github.com/user/reponame',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/JaimeSilva/jaime38130/archive/refs/tags/v_01.tar.gz',    # I explain this later on
